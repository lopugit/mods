/*!
 * chakra-ui v0.2.4 - https://github.com/segunadebayo/chakra-ui
 * MIT Licensed
 */
...
var theme_theme = {
  ...
  shadows: {
    ...
    xl: "0 50px 100px 0 rgba(26, 32, 44, 0.1), 0 15px 35px 0 rgba(26, 32, 44, 0.1), 0 5px 15px 0 rgba(0, 0, 0, .07)",
    inner: "inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)",
    focusring: "0 0 0 3px rgba(66, 153, 225, 0.5)",
    menu: "rgba(26, 32, 44, 0.05) 0px 0px 0px 1px,rgba(26, 32, 44, 0.1) 0px 3px 6px, rgba(26, 32, 44, 0.2) 0px 9px 24px;",
    none: "none",
    modal: "0 7px 14px 0 rgba(60, 66, 87, 0.1), 0 3px 6px 0 rgba(0, 0, 0, 0.07)"
  },
  space: ["0", "0.25rem", "0.5rem", "0.75rem", "1rem", "1.25rem", "1.5rem", "2rem", "2.5rem", "3rem", "4rem", "5rem", "6rem", "8rem", "10rem", "12rem", "14rem", "16rem"],
  maxWidths: {
    "2xs": "16rem",
    xs: "20rem",
    sm: "24rem",
...
/* harmony default export */ var src_theme = (theme_theme);
...
var EmotionCacheContext = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createContext"])(cache_browser_esm());
...
var core_browser_esm_withEmotionCache = function withEmotionCache(func) {
  var render = function render(props, ref) {
    return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(EmotionCacheContext.Consumer, null, function ( // $FlowFixMe we know it won't be null
    cache) {
...
var core_browser_esm_render = function render(cache, props, theme, ref) {
  ...
  for (var key in props) {
    if (core_browser_esm_hasOwnProperty.call(props, key) && key !== 'css' && key !== typePropName && ("production" === 'production' || key !== labelPropName)) {
...
function core_browser_esm_merge(registered, css$$1, className) {
  var registeredStyles = [];
...
var ClassNames = core_browser_esm_withEmotionCache(function (props, context) {
  return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(ThemeContext.Consumer, null, function (theme) {
    ...
    var cx = function cx() {
      ...
      return core_browser_esm_merge(context.registered, css$$1, classnames(args));
    };
...
var emotion_theming_browser_esm_getTheme = function getTheme(outerTheme, theme) {
  ...
  return object_assign_default()({}, outerTheme, theme);
};

var createCacheWithTheme = weak_memoize_browser_esm(function (outerTheme) {
  return weak_memoize_browser_esm(function (theme) {
    return emotion_theming_browser_esm_getTheme(outerTheme, theme);
  });
});

var emotion_theming_browser_esm_ThemeProvider = function ThemeProvider(props) {
  return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(ThemeContext.Consumer, null, function (theme) {
    if (props.theme !== theme) {
      theme = createCacheWithTheme(theme)(props.theme);
    }

    return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(ThemeContext.Provider, {
      value: theme
    }, props.children);
  });
};
...
var emotion_theming_browser_esm_withTheme = function withTheme(Component) {
  var componentName = Component.displayName || Component.name || 'Component';

  var render = function render(props, ref) {
    return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(ThemeContext.Consumer, null, function (theme) {
      return Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["createElement"])(Component, _extends({
        theme: theme,
        ref: ref
      }, props));
    });
  ...
  var WithTheme = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["forwardRef"])(render);
...
var ThemeProvider_ThemeProvider = function ThemeProvider(_ref) {
  ...
  return core_browser_esm_jsx(
    emotion_theming_browser_esm_ThemeProvider,
    { theme: theme },
    children
  );
};

ThemeProvider_ThemeProvider.defaultProps = {
  theme: src_theme
};
    ...
    for (var key in props) {
      ...
      if (typeof raw === 'object') {
        ...
        if (Array.isArray(raw)) {
          ...
          styles = index_esm_merge(styles, index_esm_parseResponsiveStyle(cache.media, sx, scale, raw));
          continue;
        }

        if (raw !== null) {
          styles = index_esm_merge(styles, index_esm_parseResponsiveObject(cache.breakpoints, sx, scale, raw));
        }

        continue;
      }

      object_assign_default()(styles, sx(raw, scale));
    }
...
var index_esm_parseResponsiveStyle = function parseResponsiveStyle(mediaQueries, sx, scale, raw) {
  var styles = {};
...
var index_esm_parseResponsiveObject = function parseResponsiveObject(breakpoints, sx, scale, raw) {
  var styles = {};
...
configs.margin = {
  margin: {
    ...
    defaultScale: index_esm_defaults.space
  },
  marginTop: {
    property: 'marginTop',
    scale: 'space',
...
var space = system(index_esm_extends({}, configs.margin, configs.padding));
/* harmony default export */ var index_esm = (space);
...
var index_esm_getWidth = function getWidth(n, scale) {
  return get(scale, n, !index_esm_isNumber(n) || n > 1 ? n : n * 100 + '%');
};
...
var layout = system(dist_index_esm_config);
/* harmony default export */ var layout_dist_index_esm = (layout);
...
var typography_dist_index_esm_config = {
  ...
  fontSize: {
    property: 'fontSize',
    scale: 'fontSizes',
    defaultScale: dist_index_esm_defaults.fontSizes
  },
  fontWeight: {
    property: 'fontWeight',
    scale: 'fontWeights'
...
var grid_dist_index_esm_defaults = {
  space: [0, 4, 8, 16, 32, 64, 128, 256, 512]
};
var grid_dist_index_esm_config = {
  gridGap: {
    property: 'gridGap',
    scale: 'space',
    defaultScale: grid_dist_index_esm_defaults.space
  },
  gridColumnGap: {
...
var Box = styled_browser_esm.div(_templateObject, layout, color, space, background, border, position, shadow);

var Flex = styled_browser_esm(Box)(_templateObject2, flexbox);

var Grid = styled_browser_esm(Box)(_templateObject2, grid);
// CONCATENATED MODULE: ./src/index.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "theme", function() { return src_theme; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "ThemeProvider", function() { return src_ThemeProvider; });
